...
--
-- Host: 127.0.0.1
-- Tempo de geração: 04/07/2025 às 07:31
...
INSERT INTO `stores` (`id`, `codigo`, `name`, `logo`, `description`, `cnpj`, `inscricao_estadual`, `whatsapp`, `email`, `endereco`, `instagram`, `facebook`, `youtube`, `horarios`, `politicas_troca`, `politicas_gerais`, `isActive`, `createdAt`, `updatedAt`) VALUES
(1, 'loja001', 'Minha Loja', NULL, NULL, NULL, NULL, NULL, 'loja@bella.com', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, '2025-07-04 00:52:13', '2025-07-04 00:53:58');
...
INSERT INTO `users` (`id`, `name`, `email`, `senha`, `tipo`, `storeId`, `createdAt`, `updatedAt`) VALUES
(1, 'Admin Master', 'admin@bella.com', '123', 'admin_master', NULL, '2025-07-04 00:48:43', '2025-07-04 00:54:15'),
(2, 'Lojista', 'lojista@bella.com', '123', 'admin_loja', 1, '2025-07-04 00:53:16', '2025-07-04 00:53:16');
